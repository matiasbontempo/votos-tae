...
export const DEMO_OPTIONS: VoteOption[] = [
  {
    id: "a",
    name: "Vera Lindqvist",
    subtitle: "La heredera",
    blurb:
      "Tenía el motivo más antiguo de todos: el dinero que nunca le tocó, y una firma que aprendió a imitar de chica.",
    color: "#e11d48",
    imageUrl: null,
    sortOrder: 1,
  },
  {
    ...
    subtitle: "El socio",
    blurb:
      "Sabía exactamente cuánto valía ese silencio. También sabía cuánto costaba romperlo, y llevaba encima las dos cifras.",
    color: "#f59e0b",
    imageUrl: null,
    sortOrder: 2,
  },
  {
    id: "c",
    name: "Ada Moreau",
    subtitle: "La institutriz",
    blurb:
      "Nadie mira a quien sirve el té. Ella contó con eso toda la noche, y con que la puerta de servicio no chirría.",
    color: "#10b981",
    imageUrl: null,
    sortOrder: 3,
  },
  {
    id: "d",
    name: "Inspector Braun",
    subtitle: "El que llegó primero",
    blurb:
      "Apareció demasiado rápido para alguien a quien nadie había llamado todavía. Y conocía el nombre de la víctima.",
    color: "#3b82f6",
    imageUrl: null,
    sortOrder: 4,
  },
